                ...
                <div class="col-md-12 col-12">
                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Sửa hồ sơ</li>
                        </ol>
                    </nav>
                    <h2 class="breadcrumb-title">Sửa hồ sơ</h2>
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <div class="change-avatar">
                                            ...
                                            <div class="upload-img">
                                                <div class="change-photo-btn">
                                                    <span><i class="fa fa-upload"></i> Tải lên hình ảnh</span>
                                                    <input type="file" class="upload" name="file">
                                                </div>
                                                <small class="form-text text-muted">Cho phép JPG, GIF hoặc PNG. Kích thước
                                                    tối đa 2MB</small>
                                            </div>
                                        </div>
                                    </div>
