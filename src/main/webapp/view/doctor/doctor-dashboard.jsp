						...
						<div class="col-md-12 col-12">
							<nav aria-label="breadcrumb" class="page-breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Bảng điều kiển</li>
								</ol>
							</nav>
							<h2 class="breadcrumb-title">Bảng điều kiển</h2>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							<div class="row">
								<div class="col-md-12">
									<h4 class="mb-4">Cuộc hẹn bệnh nhân</h4>
									<div class="appointment-tab">
									
										<!-- Appointment Tab -->
										<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded">
											<li class="nav-item">
												<a class="nav-link active" href="#upcoming-appointments" data-toggle="tab">Lịch trình</a>
											</li>
										</ul>
										<!-- /Appointment Tab -->
																	...
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				...
																				<a href="patient_profile?id=${b.patient.id}">${b.patient.name}<span>Bệnh nhân số: ${b.patient.id}</span></a>
																			</h2>
																		</td>
