    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 wow fadeInUp">
          ...
          <div class="text-lg">
            <p>Our clinic is a professional, trustworthy and dedicated place designed to meet the healthcare needs of our patients. With a team of experienced and enthusiastic doctors, we are committed to giving our customers the best examination and treatment experience.</p>
            <p>Our clinic is equipped with advanced and modern equipment, as well as a clean, beautiful and comfortable environment. We always work to the highest standards to ensure safety and meet customer requirements.</p>
              <p>We are committed to providing our customers with a professional and dedicated service. We understand that health is priceless, so we will constantly strive to meet the most demanding requirements of our customers.</p>
                <p>If you are looking for a reliable and professional healthcare, come to our clinic. We are committed to bringing you the best health!</p>
          </div>
        </div>
