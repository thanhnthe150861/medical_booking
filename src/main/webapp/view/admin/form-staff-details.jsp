                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><c:if test="${sessionScope.staff eq null}">ADD NEW</c:if><c:if
                                    test="${sessionScope.staff ne null}">UPDATE</c:if> STAFF</h4>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="username" required <c:if
                                                test="${sessionScope.staff ne null}"> readonly="readonly"
                                               value="${sessionScope.staff.account.username}"</c:if>>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="password" required
                                               value="${sessionScope.staff.account.password}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="phone" required
                                               value="${sessionScope.staff.account.phone}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="email" required
                                               value="${sessionScope.staff.account.email}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <select class="form-control select" name="status" required>
                                            <option value="true" ${sessionScope.staff.account.status == true ? "selected" : ""}>
                                                Active
                                            </option>
                                            <option value="false" ${sessionScope.staff.account.status == false ? "selected" : ""}>
                                                Deactive
                                            </option>
                                        </select>
                                    </div>
                ...
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title"><c:if test="${sessionScope.staff eq null}">ADD NEW</c:if><c:if test="${sessionScope.staff ne null}">UPDATE</c:if> STAFF</h4>
									<!-- Place this code where you want to display the error message -->
									<% String errorMessage = (String) request.getAttribute("messError"); %>
									<% if (errorMessage != null && !errorMessage.isEmpty()) { %>
									<div class="alert alert-danger" role="alert">
