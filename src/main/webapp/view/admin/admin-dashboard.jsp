...
<%--													<img class="avatar-img rounded-circle" alt="User Image" src="view/admin/assets/img/doctors/doctor-thumb-01.jpg">--%>
<%--												</span>--%>
...
<%--									<div class="media">--%>
<%--												<span class="avatar avatar-sm">--%>
<%--													<img class="avatar-img rounded-circle" alt="User Image" src="view/admin/assets/img/patients/patient1.jpg">--%>
<%--												</span>--%>
<%--										<div class="media-body">--%>
...
<%--									<div class="media">--%>
<%--												<span class="avatar avatar-sm">--%>
<%--													<img class="avatar-img rounded-circle" alt="User Image" src="view/admin/assets/img/patients/patient2.jpg">--%>
<%--												</span>--%>
<%--										<div class="media-body">--%>
...
<%--									<div class="media">--%>
<%--												<span class="avatar avatar-sm">--%>
<%--													<img class="avatar-img rounded-circle" alt="User Image" src="view/admin/assets/img/patients/patient3.jpg">--%>
<%--												</span>--%>
<%--										<div class="media-body">--%>
