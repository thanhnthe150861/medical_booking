        ...
        <div class="login-wrap p-0">
          ...
          <form action="reset_password" class="login-form" method="post">
            <div class="form-group">
              <input type="text" hidden="hidden" class="form-control" placeholder="Tài khoản" value="${requestScope.account.username}" name="username" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <input  type="text" class="form-control" name="repassword" placeholder="Mật khẩu mới" required>
              <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
            </div>
            <div class="form-group">
