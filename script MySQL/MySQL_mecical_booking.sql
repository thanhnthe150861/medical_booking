...
ALTER TABLE client ADD CONSTRAINT fk_client_rank FOREIGN KEY (rank_id) REFERENCES rank_client (id);
ALTER TABLE client ADD CONSTRAINT fk_client_account FOREIGN KEY (username) REFERENCES account (username);
...
ALTER TABLE booking ADD CONSTRAINT fk_booking_client FOREIGN KEY (client_id) REFERENCES client (id);
...
INSERT INTO account (username, password, phone, email, isAdmin) VALUES ('client', '123', '0916728374', 'takassi@gmail.com', 2);
...
INSERT INTO client (username, picture, name, gender, dob, rank_id) VALUES ('client', NULL, 'John Doe', 'Male', '1990-01-01', 1);
INSERT INTO client (username, picture, name, gender, dob, rank_id) VALUES ('client1', NULL, 'Sarah Lee', 'Female', '1985-05-05', 2);
INSERT INTO client (username, picture, name, gender, dob, rank_id) VALUES ('client2', NULL, 'Peter Kim', 'Male', '1978-06-06', 3);
INSERT INTO client (username, picture, name, gender, dob, rank_id) VALUES ('client3', NULL, 'Ngân', 'Female', '1992-02-02', 2);
