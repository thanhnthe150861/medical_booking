...
INSERT INTO account (username, password, phone, email, isAdmin) VALUES ('staff1', '123', '1234567890', 'user1@example.com', 3); 
INSERT INTO account (username, password, phone, email, isAdmin) VALUES ('staff2', '123', '0987654321', 'user2@example.com', 3); 
INSERT INTO account (username, password, phone, email, isAdmin) VALUES ('staff3', '123', '9876543210', 'user3@example.com', 3); 
INSERT INTO account (username, password, phone, email, isAdmin) VALUES ('staff4', '123', '0123456789', 'user4@example.com', 3); 
INSERT INTO account (username, password, phone, email, isAdmin) VALUES ('staff5', '123', '5432109876', 'user5@example.com', 3); 
...
SELECT COUNT(*) AS total_booking FROM booking WHERE status = 'Confirmed';
SELECT SUM(price) AS total_amount FROM bill WHERE payment_status = 'Paid';